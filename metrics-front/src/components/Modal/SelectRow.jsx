...
const SelectRow = (props) => {
    ...
    useEffect(() => {
        ...
        if(props.selected === 0) {
            ...
            auxContent.timestamp = props.content.transactions[auxSelected-1].timestamp;
            auxContent.description = `${props.content.transactions[auxSelected-1].type} ${props.content.transactions[auxSelected-1].value}`;
            auxContent.duration = `${props.content.transactions[auxSelected-1].duration} ms.`;
        }
